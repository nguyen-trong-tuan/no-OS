...
+---------------------------+-----------------+-------------------------------------------+
| AD3530R_CH_OPERATING_     | 0x0             | Operating mode 0                          |
| MODE_0                    |                 |                                           |
+---------------------------+-----------------+-------------------------------------------+
| AD3530R_CH_OPERATING_     | 0x1             | Operating mode 1                          |
| MODE_1                    |                 |                                           |
+---------------------------+-----------------+-------------------------------------------+
| AD3530R_CH_OPERATING_     | 0x2             | Operating mode 2                          |
| MODE_2                    |                 |                                           |
+---------------------------+-----------------+-------------------------------------------+
| AD3530R_CH_OPERATING_     | 0x3             | Operating mode 3                          |
| MODE_3                    |                 |                                           |
+---------------------------+-----------------+-------------------------------------------+
...
+---------------------------+-----------------+-----------+-----------------+
| Output Range              | Description     | Value     | Voltage Range   |
+---------------------------+-----------------+-----------+-----------------+
| AD3530R_CH_OUTPUT_        | 0V to VREF      | 0x0       | 0V to VREF      |
| RANGE_0_VREF              |                 |           |                 |
+---------------------------+-----------------+-----------+-----------------+
| AD3530R_CH_OUTPUT_        | 0V to 2*VREF    | 0x1       | 0V to 2*VREF    |
| RANGE_0_2VREF             |                 |           |                 |
+---------------------------+-----------------+-----------+-----------------+
...
+--------------------------------------------+------------------------+-------------------+
| AD3530R_WRITE_DAC_REGS                     | Write directly to DAC  | Immediate output  |
|                                            | registers, immediate   | update            |
|                                            | output update          |                   |
+--------------------------------------------+------------------------+-------------------+
| AD3530R_WRITE_INPUT_REGS                   | Write to input         | Synchronized      |
|                                            | registers, manual      | updates with LDAC |
|                                            | LDAC trigger required  |                   |
+--------------------------------------------+------------------------+-------------------+
| AD3530R_WRITE_INPUT_REGS_AND_TRIGGER_LDAC  | Write to input         | Synchronized      |
